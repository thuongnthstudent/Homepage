...
public class BookAdapter_homepage extends RecyclerView.Adapter<BookAdapter_homepage.ViewHoler> {

    Context context;
    ArrayList<Book_homepage> book_homepages;

    public BookAdapter_homepage(Context context, ArrayList<Book_homepage> book_homepages) {
